...
-- Dumping data for table vehicles_reservation_db.location: ~0 rows (approximately)
...
-- Dumping data for table vehicles_reservation_db.vehicle: ~0 rows (approximately)
...
-- Dumping data for table vehicles_reservation_db.vehicle_manufacturer: ~0 rows (approximately)
...
-- Dumping data for table vehicles_reservation_db.vehicle_model: ~0 rows (approximately)
