...
public class VehicleRepositoryImpl implements VehicleRepositoryCustom {
    ...
    public List<VehicleLocationVehicleModelVehicleManufacturer> getAllExtendedByCompanyIdAndDeleted(Integer companyId, Byte deleted) {
        return entityManager.createNativeQuery(SQL_GET_ALL_EXTENDED, "VehicleLocationVehicleModelVehicleManufacturerMapping").setParameter(1, companyId).setParameter(2, deleted).setParameter(1, companyId).getResultList();
    }
}
